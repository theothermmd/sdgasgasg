...
const Budget = () => {
  ...
  const handleAdd = async (data) => {
    ...
    const newData = {
      ...
      Amount: unformatNumber(data?.amount), // Unformat before sending to API
  ...
  const handleFillData = async (data) => {
    reset({
      ...
      description: data?.Description,
      amount: formatNumber(data?.Amount), // Format when filling form
    });
    setInEditMode(true);
  ...
  const column = [
    ...
    },
    {
      ...
      render: (text) => formatNumber(text), // Format amount in table
          ...
          <div>
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input
                  {...field}
                  value={formatNumber(field.value)} // Format display value
                  onChange={(e) => {
