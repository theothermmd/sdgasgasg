  ...
  return (
    <div className='bg-white  p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-5 gap-6 items-end'>
          ...
          <div>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Select {...field} allowClear optionFilterProp='label' showSearch labelInValue options={usersData} placeholder='انتخاب نام ذینفع' className='w-full rounded-full' />
              )}
            />
          </div>
          ...
          <div className='flex'>
            <button type='submit' className='bg-blue-600 text-white px-3 py-[0.40rem] rounded-md text-sm hover:bg-blue-700 transition'>
      ...
      {/* <div className="border-b flex gap-4">
        <div
          onClick={handleAdd}
          className=" flex gap-2 text-primary pb-3 cursor-pointer"
        >
          <IoAddCircleOutline className="size-6 " color="#086af3" />
          <div style={{ fontSize: "13px" }} className="font-bold mt-1">
            افزودن
          </div>
        </div>
      </div> */}
