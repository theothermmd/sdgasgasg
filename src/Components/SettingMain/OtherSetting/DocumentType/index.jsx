...
import { useCreateDocumentType, useDeleteDocumentTypeById, useEditDocumentType, useGetDocumentType } from '../../../../ApiHooks/OtherSetting/DocumentType';
const DocumentType = () => {
  ...
  const { mutateAsync: Create } = useCreateDocumentType();
  const { mutateAsync: Update } = useEditDocumentType();
  const { mutateAsync: Delete } = useDeleteDocumentTypeById();
  const { data: DataList, refetch: refetchSourceRef } = useGetDocumentType();
  useEffect(() => {
    if (DataList) {
